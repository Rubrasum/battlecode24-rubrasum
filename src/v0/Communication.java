...
class Communication {
    ...
    static MapLocation getClosestWell(RobotController rc, int resourceTypeIdentifier) {
        int start = MANA_WELL_IDX; // Default start index
        if (resourceTypeIdentifier == YOUR_ADAMANTIUM_IDENTIFIER) {
            start = ADA_WELL_IDX; // Specific start index for a different resource type
        }
